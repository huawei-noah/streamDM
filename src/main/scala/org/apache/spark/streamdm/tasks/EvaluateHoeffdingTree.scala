 ...
 *
 */
class EvaluateHoeffdingTree extends Task {

  //  val learnerOption: ClassOption = new ClassOption("learner", 'l',
  //    "Learner to use", classOf[Classifier], "bayes.MultinomialNaiveBayes")
  ...
  val streamReaderOption: ClassOption = new ClassOption("streamReader", 's',
    "Stream reader to use", classOf[StreamReader], "generators.RandomTreeGenerator")
